        ...
        <div class="col-span-3 bg-white p-6 rounded-md">
            ...
            <?php if (!empty($news['image'])): ?>
                <img src="data:image/jpeg;base64,<?php echo base64_encode($news['image']); ?>" 
                    class="w-100 h-100 object-cover rounded-md shadow-md mb-6">
            <?php endif; ?>
...
<hr class="m-5">
            ...
            <div class="text-gray-500 text-sm p-5">
                <span><i class="bx bx-user"></i> bilecoinc</span>
                <span class="ml-4"><i class="bx bx-calendar"></i> <?php echo date("F d, Y", strtotime($news['date'])); ?></span>
                
<!-- Comment Count Display -->
<span class="ml-4"><i class="bx bx-comment"></i> <?php echo $comment_count; ?> Comments</span>
            </div>
<hr class="mb-5">

            <!-- Social Share Buttons -->
            <div class="flex space-x-4 mb-6">
                <a href="#" class="bg-blue-500 text-white px-3 py-2 rounded-md hover:bg-blue-600 transition">Facebook</a>
                <a href="#" class="bg-red-500 text-white px-3 py-2 rounded-md hover:bg-red-600 transition">Pinterest</a>
                <a href="#" class="bg-blue-400 text-white px-3 py-2 rounded-md hover:bg-blue-500 transition">Twitter</a>
                <a href="#" class="bg-gray-700 text-white px-3 py-2 rounded-md hover:bg-gray-800 transition">LinkedIn</a>
            </div>
...
<div class="flex justify-between border-t pt-4">
    <?php if ($prevPost): ?>
        <a href="news-details.php?id=<?php echo $prevPost['id']; ?>" class="text-blue-600 hover:underline">
            <i class="bx bx-left-arrow-alt"></i> <?php echo htmlspecialchars($prevPost['title']); ?>
        </a>
    <?php else: ?>
        <span></span>
    <?php endif; ?>
    ...
    <?php if ($nextPost): ?>
        <a href="news-details.php?id=<?php echo $nextPost['id']; ?>" class="text-blue-600 hover:underline">
            <?php echo htmlspecialchars($nextPost['title']); ?> <i class="bx bx-right-arrow-alt"></i>
        </a>
    <?php else: ?>
        <span></span>
    <?php endif; ?>
...
<div class="grid grid-cols-1 md:grid-cols-3 gap-4">
    <?php foreach ($relatedPosts as $post): ?>
        <div class="bg-white p-4 rounded-md shadow-md">
            ...
            <a href="news-details.php?id=<?php echo $post['id']; ?>" class="text-blue-600 hover:underline">
