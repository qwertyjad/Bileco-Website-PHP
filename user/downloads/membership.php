...
<body class="bg-white">
    ...
    <h2 class="text-2xl font-bold text-[#87CEEB] mb-4">MEMBERSHIP MASTER LIST</h2>
    <hr class="border-t-4 border-b-4 border-[#ffdb19] mt-1 mb-8">
    <ul class="list-disc pl-5 space-y-2 text-gray-700">
        <li><a href="newsletters/2017-newsletter.pdf" class="text-gray-700 no-underline hover:text-blue-500"> Almeria (as of April 2022)</a></li>
        <li><a href="newsletters/2016-newsletter.pdf" class="text-gray-700 no-underline hover:text-blue-500">Biliran (as of June 2023)</a></li>
        <li><a href="newsletters/2014-newsletter.pdf" class="text-gray-700 no-underline hover:text-blue-500">Cabucgayan (as of April 2022)</a></li>
        <li><a href="newsletters/2014-newsletter.pdf" class="text-gray-700 no-underline hover:text-blue-500">Caibiran (as of April 2022)</a></li>
        <li><a href="newsletters/2014-newsletter.pdf" class="text-gray-700 no-underline hover:text-blue-500">Culaba (as of April 2022)</a></li>
        <li><a href="newsletters/2014-newsletter.pdf" class="text-gray-700 no-underline hover:text-blue-500">Kawayan (as of April 2022)</a></li>
        <li><a href="newsletters/2014-newsletter.pdf" class="text-gray-700 no-underline hover:text-blue-500">Naval (as of April 2022)</a></li>
    </ul>
</div>
