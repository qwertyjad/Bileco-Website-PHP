<div class="bg-[#13274F] text-white px-4 py-8">
            ...
            <div class="w-full lg:w-1/4 -mx-3 justify-center items-center">
                ...
                <a href="<?php echo BASE_URL; ?>">
                    ...
                    <li class="flex items-center space-x-2">
                        ...
                        <span>Brgy. Caraycaray, Naval, Biliran 6560</span>
                    </li>
                    <li class="flex items-center space-x-2">
                        <i class="fas fa-phone-alt w-5 text-white"></i>
                        <span>(053) 500-9042</span>
                    </li>
                    <li class="flex items-center space-x-2">
                        <i class="fas fa-mobile-alt w-5 text-white"></i>
                        <span>09052559119 / 09486749991</span>
                    </li>
                    <li class="flex items-center space-x-2">
                        <i class="fas fa-fax w-5 text-white"></i>
                        <span>(053) 500-9744</span>
                    </li>
                    <li class="flex items-center space-x-2">
                        <i class="fas fa-envelope w-5 text-white"></i> 
                        <a href="mailto:bileco1973@gmail.com" class="text-white hover:underline">
                            bileco1973@gmail.com
                        </a>
                    </li>
                </ul>


                    <div class="flex mt-10 -mx-2 justify-center items-center ">
                        <a href="#" class="mx-5 text-gray-300 hover:text-yellow" aria-label="Facebook">
                            <i class="fab fa-facebook"></i>
                        </a>
                        <a href="#" class="mx-5 text-gray-300 hover:text-yellow" aria-label="Twitter">
                            <i class="fab fa-twitter"></i>
                        </a>
                        <a href="#" class="mx-5 text-gray-300 hover:text-yellow" aria-label="YouTube">
                            <i class="fab fa-youtube"></i>
                        </a>
                    </div>
                </div>
            </div>
            <div class="h-50 w-px bg-gray-500 mx-20 hidden md:block"></div>

            <!-- Right Side (Links and Partners) -->
