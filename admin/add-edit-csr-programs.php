...
$item = $id ? $functions->getCSRProgramsById($id) : null;
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($id) {
        ...
        $success = $functions->updateCSRPrograms($id, $title, $content, $date, $image);
        $message = $success ? "CSR Program updated successfully!" : "Failed to update CSR Program.";
    } else {
        // Add new item
        $success = $functions->addCSRPrograms($title, $content, $date, $image);
        $message = $success ? "CSR Program added successfully!" : "Failed to add CSR Program.";
    }
...
<head>
    ...
    <title><?php echo $id ? 'Edit' : 'Add'; ?> CSR Program</title>
                ...
                <div class="bg-white">
                    <div class="max-w-6xl mx-auto ">
                        <h2 class="text-xl md:text-2xl font-semibold text-gray-800 mb-6 flex items-center">
                            <i class='bx bx-heart text-blue-600 text-xl md:text-2xl mr-2'></i>
                            <?php echo $id ? 'Edit' : 'Add'; ?> CSR Program
                        </h2>
