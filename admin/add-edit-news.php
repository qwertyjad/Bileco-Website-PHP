...
$item = $id ? $functions->getNewsById($id) : null;
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($id) {
        ...
        $success = $functions->updateNews($id, $title, $content, $date, $image);
        $message = $success ? "News updated successfully!" : "Failed to update News.";
    } else {
        // Add new item
        $success = $functions->addNews($title, $content, $date, $image);
...
<head>
    ...
    <title><?php echo $id ? 'Edit' : 'Add'; ?> News</title>
