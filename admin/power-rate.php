...
// Fetch Power Rate entries
$powerRateList = $functions->getPaginatedPowerRate($limit, $offset);
$total = $functions->getPowerRateCount();
                ...
                <div class="bg-white">
                    <div class="max-w-6xl mx-auto bg-white p-2 rounded-lg">
                        <h2 class="text-xl md:text-2xl font-semibold text-gray-800 mb-4 flex items-center">
                            <i class='bx bx-dollar text-blue-600 text-xl md:text-2xl mr-2'></i> Manage Power Rate
                        </h2>
                        ...
                        <a href="add-edit-power-rate.php" class="bg-green-600 hover:bg-green-700 text-white px-4 py-2 rounded-lg shadow-md font-medium flex items-center w-fit">
                            <i class='bx bx-plus text-lg mr-1'></i> Add Power Rate
                        </a>
                            ...
                            <table class="w-full bg-white border border-gray-200 rounded-lg shadow-lg text-sm">
                                <thead>
                                    <tr class="bg-gray-200 text-gray-700 text-left">
                                        ...
                                        <th class="py-3 px-4 text-center"><i class='bx bx-dollar'></i> Title</th>
                                ...
                                <tbody>
                                    <?php if (!empty($powerRateList)): ?>
                                        <?php foreach ($powerRateList as $item): ?>
                                            <tr class="border-b hover:bg-gray-100 transition-all">
                                                ...
                                                <td class="py-3 px-4 text-center">
                                                    <div class="flex justify-center space-x-2">
                                                        <a href="add-edit-power-rate.php?id=<?php echo $item['id']; ?>" class="bg-blue-500 hover:bg-blue-600 text-white px-3 py-2 rounded-lg shadow-md transition-all">
                                                            <i class='bx bx-edit'></i>
                                                        </a>
                                                        <a href="delete-power-rate.php?id=<?php echo $item['id']; ?>" onclick="return confirm('Are you sure?');" class="bg-red-500 hover:bg-red-600 text-white px-3 py-2 rounded-lg shadow-md transition-all">
                                    ...
                                    <?php else: ?>
                                        <tr>
                                            <td colspan="4" class="py-4 px-4 text-center text-gray-500">No Power Rate entries available.</td>
                                        </tr>
                                    <?php endif; ?>
                                </tbody>
                            </table>
                        ...
                        <div class="mt-6 flex justify-center space-x-2">
                            <?php for ($i = 1; $i <= $totalPages; $i++): ?>
                                <a href="power-rate.php?page=<?php echo $i; ?>" class="px-4 py-2 border rounded-lg text-sm font-medium shadow-md transition-all
