...
$item = $id ? $functions->getGenerationMixById($id) : null;
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($id) {
        ...
        $success = $functions->updateGenerationMix($id, $title, $content, $date, $image);
        $message = $success ? "Generation Mix updated successfully!" : "Failed to update Generation Mix.";
    } else {
        // Add new item
        $success = $functions->addGenerationMix($title, $content, $date, $image);
        $message = $success ? "Generation Mix added successfully!" : "Failed to add Generation Mix.";
    }
...
<head>
    ...
    <title><?php echo $id ? 'Edit' : 'Add'; ?> Generation Mix</title>
                ...
                <div class="bg-white">
                    <div class="max-w-6xl mx-auto ">
                        <h2 class="text-xl md:text-2xl font-semibold text-gray-800 mb-6 flex items-center">
                            <i class='bx bx-bolt text-blue-600 text-xl md:text-2xl mr-2'></i>
                            <?php echo $id ? 'Edit' : 'Add'; ?> Generation Mix
                        </h2>
