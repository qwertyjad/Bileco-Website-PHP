...
$item = $id ? $functions->getMaintenanceById($id) : null;
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($id) {
        ...
        $success = $functions->updateMaintenance($id, $title, $content, $date, $image);
        $message = $success ? "Maintenance updated successfully!" : "Failed to update Maintenance.";
    } else {
        // Add new item
        $success = $functions->addMaintenance($title, $content, $date, $image);
        $message = $success ? "Maintenance added successfully!" : "Failed to add Maintenance.";
    }
...
<head>
    ...
    <title><?php echo $id ? 'Edit' : 'Add'; ?> Maintenance</title>
                ...
                <div class="bg-white">
                    <div class="max-w-6xl mx-auto ">
                        <h2 class="text-xl md:text-2xl font-semibold text-gray-800 mb-6 flex items-center">
                            <i class='bx bx-wrench text-blue-600 text-xl md:text-2xl mr-2'></i>
                            <?php echo $id ? 'Edit' : 'Add'; ?> Maintenance
                        </h2>
