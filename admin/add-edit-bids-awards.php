...
$item = $id ? $functions->getBidsAwardsById($id) : null;
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($id) {
        ...
        $success = $functions->updateBidsAwards($id, $title, $content, $date, $image);
        $message = $success ? "Bids/Awards updated successfully!" : "Failed to update bids/awards.";
    } else {
        // Add new item
        $success = $functions->addBidsAwards($title, $content, $date, $image);
        $message = $success ? "Bids/Awards added successfully!" : "Failed to add bids/awards.";
    }
...
<head>
    ...
    <title><?php echo $id ? 'Edit' : 'Add'; ?> Bids and Awards</title>
                ...
                <div class="bg-white">
                    <div class="max-w-6xl mx-auto">
                        <h2 class="text-xl md:text-2xl font-semibold text-gray-800 mb-6 flex items-center">
                            <i class='bx bx-gavel text-blue-600 text-xl md:text-2xl mr-2'></i>
                            <?php echo $id ? 'Edit' : 'Add'; ?> Bids and Awards
                        </h2>
