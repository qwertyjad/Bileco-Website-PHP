...
$item = $id ? $functions->getNationalStoriesById($id) : null;
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($id) {
        ...
        $success = $functions->updateNationalStories($id, $title, $content, $date, $image);
        $message = $success ? "National Story updated successfully!" : "Failed to update National Story.";
    } else {
        // Add new item
        $success = $functions->addNationalStories($title, $content, $date, $image);
        $message = $success ? "National Story added successfully!" : "Failed to add National Story.";
    }
...
<head>
    ...
    <title><?php echo $id ? 'Edit' : 'Add'; ?> National Story</title>
                ...
                <div class="bg-white">
                    <div class="max-w-6xl mx-auto ">
                        <h2 class="text-xl md:text-2xl font-semibold text-gray-800 mb-6 flex items-center">
                            <i class='bx bx-news text-blue-600 text-xl md:text-2xl mr-2'></i>
                            <?php echo $id ? 'Edit' : 'Add'; ?> National Story
                        </h2>
